...
COMMISSIONED_USERS = {"carina", "francisco", "javier", "jonatan", "juan", "juancruz", "lucia", "micaela"}
COMMISSIONED_VENDORS = {"Carina", "Francisco", "Javier", "Jonatan", "Juan Cruz M.", "Lucia", "Micaela"}
